...
import { BookOpen, Building2, ChevronDown, ChevronRight, Factory, Share2 } from 'lucide-react'
...
export default function Dashboard() {
  ...
  const kpis = [
    { label: '课程总数', value: meta.total_courses, icon: BookOpen, color: 'text-accent-primary' },
    { label: '实训室', value: meta.total_labs, icon: Building2, color: 'text-accent-blue' },
    { label: '厂商课程', value: meta.total_vendor_courses, icon: Factory, color: 'text-accent-orange' },
    { label: '共享课程', value: meta.shared_course_count, icon: Share2, color: 'text-accent-gold' },
  ]
